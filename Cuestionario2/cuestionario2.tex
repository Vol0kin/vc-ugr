...
mediante el cuál se puede extraer información relevante sobre la imagen
...
capas convoluciones, como por ejemplo una función \texttt{ReLU}; y las
...
de \texttt{Dropout} o de \texttt{Batch Normalization}.

El segundo proceso funtamental es la \textbf{predicción}, la cuál utiliza
la información extraída en el proceso anterior para realizar algún tipo
...
conectadas con una función de activación determinada. En el ejemplo de clasificación
anterior se utilizaría la función \texttt{softmax}, la cuál da un vector de probabilidades
